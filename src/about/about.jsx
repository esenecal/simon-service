  ...
  return (
    <main className='container-fluid bg-secondary text-center'>
      <div>
        ...
        <p>Simon is a repetitive memory game where you follow the demonstrated color sequence until you make a mistake. The longer the sequence you repeat, the greater your score. -es deployment</p>
